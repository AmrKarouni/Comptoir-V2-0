...
namespace COMPTOIR.Migrations
{
    ...
    [Migration("20221220115628_initial01")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("COMPTOIR.Models.AppModels.Customer", b =>
                {
                    ...
                    b.Property<string>("Addresses01")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Addresses02")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Addresses03")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Addresses04")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Addresses05")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("COMPTOIR.Models.AppModels.TicketRecipe", b =>
                {
                    ...
                    b.Property<string>("PlaceIpAddress")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TaxTicket", b =>
                {
                    b.Property<int>("TaxesId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("COMPTOIR.Models.AppModels.Place", b =>
                {
                    b.HasOne("COMPTOIR.Models.AppModels.PlaceCategory", "PlaceCategory")
                        .WithMany("Places")
            ...
            modelBuilder.Entity("TaxTicket", b =>
                {
                    ...
                    b.HasOne("COMPTOIR.Models.AppModels.Ticket", null)
                        .WithMany()
